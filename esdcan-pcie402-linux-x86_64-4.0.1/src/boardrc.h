...
/************************************************************************
 *
 *  Copyright (c) 1996 - 2018 by esd electronics gmbh
 *
...
#define BOARD_MSI
#define BOARD_CAN_FD
#define BOARD_SERIAL_AS_STRING          /* serial # also as string in CIF_CARD for ESDCAN_CTL_CAN_INFO */
...
#define ESDACC_IRIG_B
#define ESDACC_IRIG_B_AVALON
#undef ESDACC_PXI
#define ESDACC_ARINC825
#define ESDACC_HW_TIMESTAMP  /* used in windows system layer */
#define ESDACC_BM_STATISTIC
#undef ESDACC_USE_NO_HW_TIMER
/* MJ: Measured AUTOBAUD is disabled and not testable because it does not compile (2018-08-27). */
#undef ESDACC_MEASURED_AUTOBAUD
#define ESDACC_MEASURED_BUSLOAD
#undef ESDACC_FPGA_IO
#define ESDACC_BM_TEST /* has boardrc_bm_test routine */
...
#define EEI_MAX_UNITS                   16 /* Avalable in CPCI serial */
...
#define PCI_SUB_SYSTEM_PCIE402_M_FD     0x1402  /* with Altera CGX22 */
#define PCI_SUB_SYSTEM_PCIE402_L_FD     0x1403  /* with Altera CGX30 */
...
#define ESDCAN_IDS_PCIE402_L {                             \
        ...
        0, 0, 0 }
#define ESDCAN_IDS_PCIE402_M_FD {                          \
        PCI_VENDOR_ESD, PCI_DEVICE_PCIE402,                \
        PCI_SUB_VENDOR_ESD, PCI_SUB_SYSTEM_PCIE402_M_FD,   \
        0, 0, 0 }
#define ESDCAN_IDS_PCIE402_L_FD {                          \
        PCI_VENDOR_ESD, PCI_DEVICE_PCIE402,                \
        PCI_SUB_VENDOR_ESD, PCI_SUB_SYSTEM_PCIE402_L_FD,   \
        0, 0, 0 }

#define ESDCAN_IDS_PCI                  ESDCAN_IDS_PCIE402_S, ESDCAN_IDS_PCIE402_M, ESDCAN_IDS_PCIE402_L, ESDCAN_IDS_PCIE402_M_FD, ESDCAN_IDS_PCIE402_L_FD
...
#define C402_BUS_TYPE_XMC               0x04        /* XMC version        */
#define C402_BUS_TYPE_PMC               0x05        /* PMC version        */
...
struct _FPGA_SYSTEM {
        ...
        UINT32   reserved8[0x4820];
        volatile UINT32   bmTestCore;      /* 0x14080: BM Test Base */
        volatile UINT32   bmTestCount;
        volatile UINT32   bmTestDelay;
        UINT32   reserved9[0x3DD];
        /* IRIG-B module */
        volatile UINT32   irigbImpID;      /* 0x15000: IRIG Base Addr */
...
#define CIF_CARD                                   \
        ...
        UINT8           fpgaType;                  \
        UINT8           busType;                   \
        UINT8           updaterVersion;            \
        UINT8           cif_reserved;              \
        CHAR8           serial_string[16];         \
        UINT32          irigBFrame[4];             \
        ...
        OSIF_MUTEX      lock_bm_statistic;         \
        INT32           flag_bm_statistic;         \
        OSIF_TS         bm_can_status;             \
        OSIF_TS         bm_timestamp;              \
        UINT64          osif_ticks_at_bm_timestamp;\
        UINT64          osif_ticks_diff_bm_timestamp;\
        UINT64          osif_est_ticks_at_bm_timestamp;\
        UINT32          bm_timestamp_calib;        \
...
#define STRAPPING_MASK_STRAP_2          (1 << STRAPPING_BIT_STRAP_2) /* Is IRIG-B interface */
#define STRAPPING_MASK_STRAP_3          (1 << STRAPPING_BIT_STRAP_3) /* Is not galvanically isolated */
...
void boardrc_bm_test(VOID *pCanNode, UINT32 count, UINT32 delay);
