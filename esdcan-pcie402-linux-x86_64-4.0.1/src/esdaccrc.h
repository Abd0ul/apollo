/* -*- linux-c -*-
 * FILE NAME boardrc.h
 *           copyright 2013-2018 by esd electronic system design gmbh
 *
...
/************************************************************************
 *
 *  Copyright (c) 2013 - 2018 by electronic system design gmbh
 *
...
#if !defined(__sun) && !defined(__LYNXOS) && !defined(RTOS32)
